  ...
  return (
    <>
      ...
      <header className="pb-6">
        ...
        <Paragraph>
          We&apos;re so busy crafting pixel-perfect designs for our clients that
          our own website has become the digital equivalent of a sticky note!
        </Paragraph>
      </header>
      ...
      <section className="py-6">
        ...
        <Paragraph>
          With over 5 years of experience in the industry, we have a proven
          track record of delivering high-quality, custom solutions that meet
      ...
      <section className="py-6">
        ...
        <Paragraph>
          F.H. Prager, Strava.cz, Pilsner Urquell, Bestaudio.cz, Skoda
          Transportation, Prager&apos;s, Nadační fond muži proti rakovině,
          Charles University, Jack Daniel&apos;s and much more…
        </Paragraph>
      </section>
      ...
      <section className="py-6">
        ...
        <Paragraph>
          Say hello to us at{" "}
          <a
            href="mailto:hello@acamo.cz"
            className="underline hover:bg-white hover:text-zinc-900 hover:no-underline"
          >
            hello@acamo.cz
          </a>{" "}
          or call:{" "}
          <a
            href="tel:+420775210897"
            className="underline hover:bg-white hover:text-zinc-900 hover:no-underline"
          >
            +420 775 210 897
          </a>
      ...
      <section className="py-6">
        ...
        <Paragraph className="text-sm text-zinc-500">
          ...
          The company is registered in the Commercial Register kept at the
          Regional Court in Pilsen, Section C, Insert 3108
        </Paragraph>
      </section>
    </>
  );
